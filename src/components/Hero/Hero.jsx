...
const Hero = (props) => {
  return (
    <>
      ...
      <section>
        <h2>Our Work</h2>
        <p>771 million people lack basic access to clean and safe drinking water. We've been on a mission to end the water crisis since 2006, and with the help of generous supporters like you, we're getting closer every day.</p>
        <ul>
          <li>
            <h3>120,78</h3>
